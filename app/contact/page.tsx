      ...
      <div className="container mx-auto px-4 py-16 sm:py-24">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-slate-900 dark:text-white text-4xl md:text-5xl font-bold leading-tight">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            {/* Contact Form */}
            <div className="lg:col-span-3 bg-white/50 dark:bg-black/20 p-8 rounded-xl shadow-sm">
